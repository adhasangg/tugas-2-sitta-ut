  ...
  methods: {
    ...
    validateForm() {
      ...
      if (!this.form.kode || this.form.kode.trim() === "") {
        ...
        this.modalType === "add" &&
        this.stok.some((s) => s.kode === this.form.kode.trim())
      ) {
    ...
    submitForm() {
      ...
      this.triggerAlert(
        "Berhasil",
        this.modalType === "add"
          ? "Data stok bahan ajar berhasil ditambahkan!"
          : "Data stok bahan ajar berhasil diperbarui!",
        "success",
      );
    },
